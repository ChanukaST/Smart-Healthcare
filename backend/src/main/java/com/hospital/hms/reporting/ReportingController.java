...
public class ReportingController {
    ...
    public ResponseEntity<Map<String, Object>> getDashboardStats() {
        ...
        // Performance Optimization: Replaced in-memory streaming and filtering (findAll().stream().filter(...))
        // with database-level aggregation queries (countBy..., @Query) to reduce memory consumption
        // and improve response time, especially as the dataset grows.
