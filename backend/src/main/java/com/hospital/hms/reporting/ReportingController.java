...
public class ReportingController {
    ...
    public ResponseEntity<Map<String, Object>> getDashboardStats() {
        ...
        // Optimization: Replaced inefficient in-memory filtering (e.g. findAll().stream().filter().count())
        // with native database-level aggregations (COUNT/SUM) to reduce memory consumption and DB transfer overhead.
